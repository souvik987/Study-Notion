  ...
  return (
    <div className=' bg-richblack-800'>
        <div className=' flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto py-14'>
            <div className=' border-b w-[100%] flex flex-col lg:flex-row mb-5 border-richblack-700'>
                {/* section 1 */}
                <div className='lg:w-[50%] flex flex-row flex-wrap justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3'>
                    ...
                    <div className='w-[48%] lg:w-[30%] mb-7 lg:pl-0'>
                        ...
                        <div className=' text-[14px] cursor-pointer hover:text-richblue-50 transition-all duration-200 mt-2'>
        ...
        <div className='flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm'>
            ...
            <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                ...
                <div className="text-center">Made with ❤️ Souvik Dey © 2023 Studynotion</div>
            </div>
