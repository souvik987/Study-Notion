...
const TimeLineSection = () => {
  return (
    <div>
      <div className='flex lg:flex-row flex-col mb-20 gap-20 items-center'>
        ...
        <div className='relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]'>
            ...
            <div className='absolute lg:max-w bg-caribbeangreen-700 flex flex-row text-white uppercase py-7 left-[50%] translate-x-[-50%] translate-y-[-50%]'>
